...
namespace Comics.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdFornecedor,Nome,Email,Telefone,Endereco,DataCadastro")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdFornecedor,Nome,Email,Telefone,Endereco,DataCadastro")] Fornecedor fornecedor)
        {
